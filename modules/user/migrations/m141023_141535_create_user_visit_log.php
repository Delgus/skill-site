...
class m141023_141535_create_user_visit_log extends Migration
{
    public function safeUp()
    {
        ...
        $table_name = \Yii::$app->getModule('user')->user_visit_log_table;
        if (\Yii::$app->db->schema->getTableSchema($table_name) === null) {
            ...
            $this->createTable($table_name, array(
                ...
                0 => 'FOREIGN KEY (user_id) REFERENCES ' . Yii::$app->getModule('user')->user_table . ' (id) ON DELETE SET NULL ON UPDATE CASCADE',
            ), $tableOptions);
        }
    }
    ...
    {
        $this->dropTable(Yii::$app->getModule('user')->user_visit_log_table);
