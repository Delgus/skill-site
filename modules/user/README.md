...
'modules'=>[
	'user' => [
		'class' => 'app\modules\user\UserManagementModule',
	        'controllerNamespace'=>'vendor\app\modules\user\controllers', // To prevent yii help from crashing
	],
],
...
<?php
use app\modules\user\components\GhostMenu;
	...
	'items' => [
		...
		[
			...
			'items'=>[
				...
				['label'=>'Logout', 'url'=>['user/auth/logout']],
				['label'=>'Registration', 'url'=>['user/auth/registration']],
				['label'=>'Change own password', 'url'=>['user/auth/change-own-password']],
				['label'=>'Password recovery', 'url'=>['user/auth/password-recovery']],
				['label'=>'E-mail confirmation', 'url'=>['user/auth/confirm-email']],
			],
		],
	],
]);
