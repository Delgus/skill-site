...
class ConfirmEmailForm extends Model
{
	...
	public function getTokenTimeLeft($inMinutes = false)
	{
		...
		{
			$expire    = Yii::$app->getModule('user')->confirmationTokenExpire;
	...
	public function sendEmail($performValidation = true)
	{
		...
		return Yii::$app->mailer->compose(Yii::$app->getModule('user')->mailerOptions['confirmEmailFormViewFile'], ['user' => $this->user])
