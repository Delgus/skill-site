...
class UserManagementModule extends Module
{
     ...
     * @var string
     */
    public $registrationFormClass = 'app\modules\user\models\forms\RegistrationForm';
    ...
    /**
     * Registration can be enabled either by this option or by adding 'user/auth/registration' route
    ...
    {
        return [
            ['label' => UserManagementModule::t('back', 'Users'), 'url' => ['/user/user/index']],
            ['label' => UserManagementModule::t('back', 'Roles'), 'url' => ['/user/role/index']],
            ['label' => UserManagementModule::t('back', 'Permissions'), 'url' => ['/user/permission/index']],
            ['label' => UserManagementModule::t('back', 'Permission groups'), 'url' => ['/user/auth-item-group/index']],
            ['label' => UserManagementModule::t('back', 'Visit log'), 'url' => ['/user/user-visit-log/index']],
        ];
    }
    ...
    public static function t($category, $message, $params = [], $language = null)
    {
        if (!isset(Yii::$app->i18n->translations['modules/user/*'])) {
            Yii::$app->i18n->translations['modules/user/*'] = [
                ...
                'fileMap' => [
                    'modules/user/back' => 'back.php',
                    'modules/user/front' => 'front.php',
                ],
            ];
        }
