...
return [
    ...
    'Code' => 'Код',
    'Confirmation Token' => 'Токен для подтверждения',
    'Create' => 'Создать',
    'Created' => 'Создано',
    ...
    'Refresh routes' => 'Обновить роуты',
    'Refresh routes (and delete unused)' => 'Обновить роуты(и удалить неиспользуемые)',
    ...
    'Routes' => 'Роуты',
    'Routes that are not exists in this application will be deleted. Do not recommended for application with "advanced" structure, because frontend and backend have they own set of routes.' => 'Роуты, которые не существуют в этом приложении, будут удалены.Не рекомендуется для применения с advanced структурой, поскольку фронтенд и бэкенд имеют собственный набор маршрутов.',
    'Rule' => 'Правило',
    'Save' => 'Сохранить',
    'Saved' => 'Сохранено',
    'Search' => 'Поиск',
    'Search route' => 'Найти роут',
    'Settings for permission' => 'Настройки для права',
    'Show all' => 'Показать все',
    'Show only selected' => 'Уже выбранные',
    'Status' => 'Статус',
